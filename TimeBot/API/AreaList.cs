...
namespace TimeBot.API
{
    public class AreaList
    {
        ...
        public string getArea(string _area)
        {
            #region fuckthis
            string value = "Africa/Abidjan,Africa/Accra,Africa/Algiers,Africa/Bissau,Africa/Cairo," +
                ...
                "America/Glace_Bay,America/Godthab,America/Goose_Bay,America/Grand_Turk,America/Guatemala," +
                ...
                "Asia/Srednekolymsk,Asia/Taipei,Asia/Tashkent,Asia/Tbilisi,Asia/Tehran,Asia/Thimphu,Asia/Tokyo," +
                "Asia/Tomsk,Asia/Ulaanbaatar,Asia/Urumqi,Asia/Ust-Nera,Asia/Vladivostok,Asia/Yakutsk,Asia/Yangon," +
                "Asia/Yekaterinburg,Asia/Yerevan,Atlantic/Azores,Atlantic/Bermuda,Atlantic/Canary,Atlantic/Cape_Verde," +
                "Atlantic/Faroe,Atlantic/Madeira,Atlantic/Reykjavik,Atlantic/South_Georgia,Atlantic/Stanley," +
                ...
                "Europe/Belgrade,Europe/Berlin,Europe/Brussels,Europe/Bucharest,Europe/Budapest,Europe/Chisinau," +
                "Europe/Copenhagen,Europe/Dublin,Europe/Gibraltar,Europe/Helsinki,Europe/Istanbul,Europe/Kaliningrad," +
                "Europe/Kiev,Europe/Kirov,Europe/Lisbon,Europe/London,Europe/Luxembourg,Europe/Madrid,Europe/Malta," +
                "Europe/Minsk,Europe/Monaco,Europe/Moscow,Europe/Oslo,Europe/Paris,Europe/Prague,Europe/Riga," +
                ...
                "Europe/Volgograd,Europe/Warsaw,Europe/Zaporozhye,Europe/Zurich,HST,Indian/Chagos," +
                ...
                "Pacific/Majuro,Pacific/Marquesas,Pacific/Nauru,Pacific/Niue,Pacific/Norfolk,Pacific/Noumea," +
            ...
            string xarea = string.Empty;
            var result = AreaData.Where(e => e.Contains(_area)).FirstOrDefault();
            xarea = result.ToString();
